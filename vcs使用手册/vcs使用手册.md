...
![图 4（962x414）](vcs使用手册_asset/image-08.png)
...
![图 5（968x406）](vcs使用手册_asset/image-09.png)

可以看到报错已经消失，此时目录有以下文件

![图 6（689x56）](vcs使用手册_asset/image-10.png)
...
![图 7（2540x1338）](vcs使用手册_asset/image-11.png)
...
![图 8（848x522）](vcs使用手册_asset/image-12.png)
...
![图 9（2483x1369）](vcs使用手册_asset/image-13.png)

运行后，你应该能看到波形变化，并且控制台会出现 $finish 信息和 *** Testbench Successfully completed! *** 消息。

![图 10（2559x287）](vcs使用手册_asset/image-02.png)

![图 11（2469x1366）](vcs使用手册_asset/image-03.png)

补充：在波形处点标记1处的小箭头，也能使仿真开始，可以使用2处的三个按钮(预览全局、放大和缩小)调整波形

![图 12（2484x1359）](vcs使用手册_asset/image-04.png)
...
![图 13（657x124）](vcs使用手册_asset/image-05.png)
